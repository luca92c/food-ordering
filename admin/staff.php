...
if (!empty($_POST['role']))
{
    ...
    $sqlconnection->query($updateRoleQuery);
}
?>
...
<head>
    ...
    <title>Gestione Staff - Admin</title>
...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <hr>
            <p>Gestici i membri dello staff</p>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                <tr>
                                    ...
                                    <th>Stato</th>
                                    <th>Ruolo</th>
                                    <th class="text-center">Opzione</th>
                                </tr>
                                ...
                                if ($result = $sqlconnection->query($displayStaffQuery))
                                {
                                    ...
                                    {
                                        echo "<td colspan='4'>Non ci sono membri dello staff</td>";
                                    }
                        ...
                        <div class="card-footer small text-muted"><i>La password di default per un nuovo utente è : abc123</i></div>
                    </div>
                </div>
