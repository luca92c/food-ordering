...
{
    echo ("<script>window.alert('Sezione attiva solo per gli chef!'); window.location.href='index.php';</script>");
    exit();
}
    ...
    <div id="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Cucina</li>
            </ol>

            <!-- Page Content -->
            <h1>Gestione Cucina</h1>
            <hr>
...
<script type="text/javascript">
    ...
    // aggiorno lista ordini ogni 3 secondi
